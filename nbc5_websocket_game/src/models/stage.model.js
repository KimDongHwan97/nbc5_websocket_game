...
export const setStage = (uuid, id, timestamp) => {
  return stages[uuid].push({ id, timestamp, itemScore: 0 }); // itemScore 추가
};

export const addItemScore = (uuid, id, score) => {
  stages[uuid].find((stage) => stage.id === id).itemScore += score;
}
